...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath}/web_content/dashhboard.jsp">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="${pageContext.request.contextPath}/web_content/dashhboard.jsp">
        ...
        <div class="container-fluid">
          ...
          <!-- 404 Error Text -->
            <div class="text-center">
              ...
              <a href="${pageContext.request.contextPath}/web_content/dashhboard.jsp">&larr; Back to Dashboard</a>
            </div>
